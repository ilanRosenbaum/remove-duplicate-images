...
import os
import shutil
from delete_duplicates import populate_and_remove_duplicates

class TestRemoveDuplicates(unittest.TestCase):
    def setUp(self):
        # Copy test data
        shutil.copytree('test_data/identical_photos', 'test_data/tmp/copy_photos')
        shutil.copytree('test_data/identical_videos', 'test_data/tmp/copy_videos')

    def tearDown(self):
        # Clean up new data
        shutil.rmtree('test_data/tmp/copy_photos')
        shutil.rmtree('test_data/tmp/copy_videos')
